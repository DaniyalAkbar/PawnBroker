...
public class UserCRUD {
    ...
    public  ArrayList<String> searchUserByFirstName(String fname){
        Cursor c = d.executerawquery("select * from users where Fname = '"+fname+"' COLLATE NOCASE");
    ...
    public  ArrayList<String> searchUserByLastName(String lname){
        Cursor c = d.executerawquery("select * from users where Lname = '"+lname+"' COLLATE NOCASE");
        ArrayList<String> arrayList = new ArrayList<>();
        c.moveToFirst();
        while(!c.isAfterLast()){
            String u;
